...
| Variant | Example |
|:---|:---|
| normal | `styler({ blend: 'normal' })` |
| multiply | `styler({ blend: 'multiply' })` |
| hard-light | `styler({ blend: 'hard-light' })` |
| difference | `styler({ blend: 'difference' })` |
